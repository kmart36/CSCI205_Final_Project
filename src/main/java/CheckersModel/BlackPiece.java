 ...
 *
 * Name: Phil Morgan, Doug Russo, Katy Martinson, Kiera Egan
 * Section: 02 - 9:50am
 * Date: 11/15/2021
 * Time: 10:04 AM
 *
...
/**
 * A class that represents the Black Pieces and extends from the base Piece class
 */
public class BlackPiece extends Piece {
    private Circle piece;

    /**
     * Unparameterized constructor for the BlackPiece
     */
    public BlackPiece() {
        super();
        piece = new Circle();
     ...
     * Parameterized constructor for BlackPiece
     */
